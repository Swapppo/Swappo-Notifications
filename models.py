...
class NotificationCreate(BaseModel):
    ...
    user_id: str = Field(
        ..., min_length=1, max_length=100, description="User ID to receive notification"
    )
    ...
    related_user_id: Optional[str] = Field(
        None, max_length=100, description="ID of user who triggered notification"
    )
